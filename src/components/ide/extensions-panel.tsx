  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="px-3 pb-2 flex items-center gap-2 text-[10px]">
        <button className="px-2 py-0.5 bg-[#00e5ff]/10 text-[#00e5ff] rounded font-mono cursor-pointer">Installed</button>
        <button className="px-2 py-0.5 text-[#3d4450] hover:text-[#5a6270] rounded font-mono cursor-pointer">Popular</button>
        <button className="px-2 py-0.5 text-[#3d4450] hover:text-[#5a6270] rounded font-mono cursor-pointer">Recommended</button>
      </div>
          ...
          >
            <div className="flex items-start gap-2">
              <div className="w-8 h-8 rounded bg-[#00e5ff]/10 flex items-center justify-center shrink-0">
                <Blocks size={16} className="text-[#00e5ff]/70" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  {ext.installed ? (
                    ...
                    <button className="p-1 text-[#00e5ff] hover:bg-[#00e5ff]/10 rounded cursor-pointer">
                      <Download size={12} />
                    </button>
                  )}
                </div>
                <div className="text-[10px] text-[#3d4450]">{ext.publisher}</div>
                <div className="text-[11px] text-[#5a6270] mt-0.5">{ext.desc}</div>
