...
export function StatusBar() {
  ...
  return (
    <div className="h-6 bg-[#00e5ff]/10 border-t border-[#00e5ff]/20 flex items-center justify-between px-3 text-[11px] font-mono shrink-0 select-none">
      <div className="flex items-center gap-3">
        {/* Git Branch */}
        <div className="flex items-center gap-1 text-[#00e5ff]/70 hover:text-[#00e5ff] cursor-pointer transition-colors">
          <GitBranch size={12} />
          <span>main</span>
        </div>
      ...
      <div className="flex items-center gap-3">
        {/* AI Provider Status */}
        <div className="flex items-center gap-1 text-[#5a6270] hover:text-[#00e5ff] cursor-pointer transition-colors">
          <Bot size={11} />
        ...
        {activeTab && (
          <>
            ...
            <span className="text-[#5a6270]">UTF-8</span>
            <span className="text-[#5a6270]">{activeTab.language}</span>
          </>
        )}
        ...
        <button
          ...
          className="text-[#5a6270] hover:text-[#00e5ff] transition-colors cursor-pointer"
        >
          {theme === 'dark' ? '☀' : '☾'}
        </button>
      </div>
